...
let lines = [
    'Toujours des Zero et des Un ...',
    'Toujours mon langage préféré !!',
    '',
    'Mais est-ce vraiment le tiens ?',
    'Peut-être que tu préfères les mots...avec des lettres...et des chiffres ...',
    '...',
    'Peut-être qu\'en convertissant ce message en langage que tu comprends',
    'Tu pourrais trouver la clé',
    '',
...
function startTimer() {
    ...
    alert("Encore toi ?! Tu ne lâches rien dis donc !\n\nTu as 4 minutes pour trouver la clé et passer à l'étape suivante.\n\nBonne chance !");
